...
# keyword_rankings documentation build
...
from keyword_rankings import __version__ as release

# -- Project information -----------------------------------------------------

project = "keyword_rankings"
author = "Kedro"
...
htmlhelp_basename = "keyword_rankingsdoc"
...
latex_documents = [
    (
        master_doc,
        "keyword_rankings.tex",
        "keyword_rankings Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "keyword_rankings",
        "Project keyword_rankings codebase.",
        "Data-Science",
    )
]
